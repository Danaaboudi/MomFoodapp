...
import com.example.momfood.activity.BaseActivity;
import com.example.momfood.activity.ProductViewActivity;
import com.example.momfood.model.Cart;
        ...
        if (!cartList.isEmpty()) {
            for (int i = 0; i < cartList.size(); i++) {
                if (cartList.get(i).getId().equalsIgnoreCase(product.getId())) {
                    ...
                    holder.subTotal.setText(_quantity + "X" + _price + "= ILS." + _subtotal);
                ...
                if (pQuantity >= 1) {
                    ...
                    for (int i = 0; i < cartList.size(); i++) {
                        ...
                        if (cartList.get(i).getId().equalsIgnoreCase(product.getId())) {
                            ...
                            holder.subTotal.setText(total_item + "X" + holder.price.getText().toString() + "= ILS." + _subtotal);
